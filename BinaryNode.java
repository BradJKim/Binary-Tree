class BinaryNode<T>
{
   ...
   public int getHeight_binaryNodeMethod()
   {
      if(leftChild == null && rightChild == null){
         ...
         return 1 + rightChild.getHeight_binaryNodeMethod();
      }
      else if(rightChild == null){
         return 1 + leftChild.getHeight_binaryNodeMethod();
      }
      else {
         return Math.max(1 + leftChild.getHeight_binaryNodeMethod(), 1 + rightChild.getHeight_binaryNodeMethod());
      }
   } // end getHeight
